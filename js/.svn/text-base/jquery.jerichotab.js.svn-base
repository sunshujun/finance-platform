                    ...
                    if (ps.tabFirer != null) {
                    	...
                    	if (tabHash != undefined) {
                    		for (var tab in tabHash) {
                    			if (tabHash[tab].tabDataId == ps.data.dataId) {
                    				var jerichotabindex = tabHash[tab].index;
                    		...
                    		//最多打开10个页签
                    		if(tabHash.length>=10){
                    			return alertx("最多同时打开10个页签");
                    		}
                    	}
